...
input int RSIHighLimit = 80;                               // RSI Overbought Limit
input int RSILowLimit = 2;                                // RSI Oversold Limit
...
input ENUM_ALERT_SIGNAL AlertSignal = RSI_BREAK_OUT;        // Alert Signal When
...
void NotifyHit()
{
    ...
    EmailBody += Text;
    AlertText += Text;
    AppText += Text  + " - " + DoubleToString(rsiLevel,2);
